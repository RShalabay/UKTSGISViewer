...
public class RetrofitManager {
    ...
    private RetrofitManager() {
        ...
        OkHttpClient okHttpClient = new OkHttpClient()
                ...
                .addInterceptor(chain -> {
                    ...
                    Request.Builder builder = request.newBuilder().header("user-agent", "UKTSService/"
        ...
        mRetrofit = new Retrofit.Builder()
                .baseUrl("https://ukteplo.kz/api/1.1/")
                .client(okHttpClient)
    ...
    public UKTSService getUKTSApi() {
        return mRetrofit.create(UKTSService.class);
    }
